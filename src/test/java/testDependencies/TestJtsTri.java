...
public class TestJtsTri extends PApplet {
    ...
    public static void main(String[] args) {
        PApplet.main("testDependencies.TestJtsTri");
    }
    ...
    public void setup() {
        ...
        for (int i = 0; i < terrains.length; i++) {
            ...
            List<Coordinate> split = ZGeoMath.dividePolyLineByThreshold(contour, 20, 10, 1);
            for (Coordinate p : split) {
                Point pt = ZFactory.jtsgf.createPoint(p);
                delaunayGen.add(pt);
            }
        }
