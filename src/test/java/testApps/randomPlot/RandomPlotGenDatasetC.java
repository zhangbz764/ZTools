 ...
 * @time 14:36
 */
public class RandomPlotGenDatasetC extends PApplet {
    public static void main(String[] args) {
        PApplet.main(RandomPlotGenDatasetC.class.getName());
    }
...
//    }
    ...
    public void draw() {
        ...
        if (currentTime - lastSavedTime >= saveInterval) {
            ...
            // 拼接文件名，包含帧数
            String filename = "E:\\2_data\\plotTestData\\typeC\\" + imgCount + ".jpg";
            // 保存当前画布内容为图像文件
            saveFrame(filename);
