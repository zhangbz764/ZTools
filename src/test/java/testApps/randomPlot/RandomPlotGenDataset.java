 ...
 * @time 14:36
 */
public class RandomPlotGenDataset extends PApplet {
    public static void main(String[] args) {
        PApplet.main(RandomPlotGenDataset.class.getName());
    }
...
//    }
    ...
    public void draw() {
        ...
        if (currentTime - lastSavedTime >= saveInterval) {
            ...
            // 拼接文件名，包含帧数
            String filename = "E:\\2_data\\plotTestData\\typeA\\" + imgCount + ".jpg";
            // 保存当前画布内容为图像文件
            saveFrame(filename);
